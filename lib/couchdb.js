var cradle = require('cradle'),
    ...
    //socket = require('../../server.js');
var events = require('events'),
    util   = require('util');
		

// var telChanges = function(argument) {
// 	
// };
var dbjcEvent = new events.EventEmitter();
// util.inherits(telChanges, EventEmitter);
...
//console.log(util.inspect(dbjcEvent.listeners(sendChange)))
// function(sendChanges,dbjcEvent) {
// 	console.log("new Listener");
// }

//eventEmitter.removeListe
