...
dbjc.info(function(err,res) {
	...
	dbjc.changes({since:res.update_seq}).on('response', function(res) {
		res.on('data',function(change) {
				...
				// telChanges.prototype.action = function() {
				// 	this.emit("change",change)
				// };
				   //console.log(change.id);
				  dbjc.get(change.id,function(err,res) {
						//console.log(res);
				  	if (res.countersave>0) eventEmitter.emit("change",res.query);
...
//var dbUpdate_seq;
//console.log(db.seqlist());

// var info = new(cradle.Connection)('http://home.oszko.net', 5984, {
//     auth: {
//         username: 'web',
//         password: 'web'
//     }
