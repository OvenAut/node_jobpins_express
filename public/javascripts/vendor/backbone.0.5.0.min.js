...
(function() {
    ...
    e.Events = {
        ...
        trigger: function(a) {
            ...
            for (; f--;) if (b = f ? a : "all", b = c[b]) for (var g = 0, h = b.length; g < h; g++)(d = b[g]) ? (e = f ? Array.prototype.slice.call(arguments, 1) : arguments, d.apply(this, e)) : (b.splice(g, 1), g--, h--);
            return this
        }
    };
    ...
    f.extend(e.Model.prototype, e.Events, {
        ...
        escape: function(a) {
            ...
            b = this.attributes[a];
            return this._escapedAttributes[a] = (b == null ? "" : "" + b).replace(/&(?!\w+;|#\d+;|#x[\da-f]+;)/gi, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27").replace(/\//g, "&#x2F;")
        },
        has: function(a) {
        ...
        url: function() {
            var a = j(this.collection) || this.urlRoot || k();
    ...
    f.extend(e.History.prototype, {
        ...
        start: function(a) {
            ...
            this.fragment = a;
            m = !0;
            a = this.loadUrl() || this.loadUrl(window.location.hash);
            b = window.location.pathname == this.options.root;
            if (this._wantsPushState && !this._hasPushState && !b) this.fragment = this.getFragment(null, !0), window.location = this.options.root + "#" + this.fragment;
            else if (this._wantsPushState && this._hasPushState && b && window.location.hash) this.navigate(window.location.hash);
            else return a
        },
        route: function(a, b) {
        ...
        navigate: function(a, b) {
            ...
            if (!(this.fragment == a || this.fragment == decodeURIComponent(a))) {
                if (this._hasPushState) {
                    ...
                    a.indexOf(this.options.root) != 0 && (a = this.options.root + a);
                    this.fragment = a;
                    window.history.pushState({}, document.title, c.protocol + "//" + c.host + a)
                } else if (window.location.hash = this.fragment = a, this.iframe && a != this.getFragment(this.iframe.location.hash)) this.iframe.document.open().close(), this.iframe.location.hash = a;
                b && this.loadUrl(a)
            }
        }
    });
    ...
    f.extend(e.View.prototype, e.Events, {
        ...
        delegateEvents: function(a) {
            if (a || (a = this.events)) for (var b in g(this.el).unbind(".delegateEvents" + this.cid), a) {
                var c = this[a[b]];
