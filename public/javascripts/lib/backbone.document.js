	...
	window.DocumentList = Backbone.Collection.extend({
		...
		*/
		...
		render: function(document) {
			...
			$("#column1box").empty().append(view.render().el) // .render().elappend -> Insert contentm specified by the parameters, to the end of each elements in the set of matched elements
