		...
		*/
		...
		render: function(document,bang) {
			...
			if (Document.renderData.body) {
				$(".documentdiv").html(view.render().el); // .render().elappend -> Insert contentm specified by the parameters, to the end of each elements in the set of matched elements
